...
public:
	...
	static bool execute(const vector<MetricDataCollection> data, int* result, int numElts, int num_clusters, int* initial_clusters);

};

// execute k-means

bool kmeans::execute(const vector<MetricDataCollection> data, int *result, int numElts, int num_clusters, int* initial_clusters = 0) {
