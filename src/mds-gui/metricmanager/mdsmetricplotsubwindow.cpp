#include "mdsmetricplotsubwindow.h"
#include "ui_mdsmetricplotsubwindow.h"
#include <vtkPlotPoints.h>
#include <vtkAxis.h>
#include <vtkTextProperty.h>

MDSMetricPlotSubWindow::MDSMetricPlotSubWindow(QWidget *parent) :
...
bool MDSMetricPlotSubWindow::initialize(int plotType,
                                        QString gridName,
                                        QString metricName,
...
bool MDSMetricPlotSubWindow::initializeVector(int plotType,
                                              QString gridName,
                                              QString metricName,
                                              QStringList metricProps)
{
    ...
    for (unsigned int i = 0; i<metricProps.size(); ++i)
    {
        ...
        ResponsePlotData responseVTKData;
...
bool MDSMetricPlotSubWindow::initializeTimeSeries(int plotType,
                                                  QString gridName,
                                                  QString metricName,
                                                  QStringList metricProps)
{
...
bool MDSMetricPlotSubWindow::initializeDistribution(int plotType,
                                                    QString gridName,
                                                    QString metricName,
                                                    QStringList metricProps)
{
...
MDSMetricPlotSubWindow::~MDSMetricPlotSubWindow()
{
    delete ui;
}

void MDSMetricPlotSubWindow::updatePlotVisibility(QString property,
                                                  bool visible)
{
    // Delete Plot
    if (!visible)
...
void MDSMetricPlotSubWindow::updatePlotColor(QString property,
                                             QColor newColor)
{
    int r = newColor.red();
    int b = newColor.blue();
...
void MDSMetricPlotSubWindow::changeDataTableView(QString property)
{
    tableView_->SetSplitMultiComponentColumns(true);
